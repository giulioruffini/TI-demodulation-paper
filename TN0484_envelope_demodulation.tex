...
free-running gamma, no $\Delta f$ lock-in. \emph{(d)}~Entrained, TI on, driven
\emph{detuned} ($\Delta f=42$~Hz, deliberately $\ne$ the autonomous $54$~Hz): the gamma
bursts gate to the TI beat---the population rate gains a $\Delta f$-locked component
($\sim$22$\times$), while the intrinsic gamma persists. The detuning is what makes this
genuine entrainment rather than coincidence.}
...
and $\Delta f=42$~Hz \emph{detuned} from the autonomous $54$~Hz in the entrained regime
($\bar\eta=1.5$, above the Hopf)---the detuning distinguishing true entrainment from
mere frequency coincidence. Timing is quantified by the quadrature lock-in of $r_E(t)$
at $\Delta f$ over the measurement window.

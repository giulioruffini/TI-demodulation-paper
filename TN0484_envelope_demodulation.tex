...
mode, and the gain below is its one-mode (center-manifold) reduction. Just below a supercritical Hopf, $\gamma\to0^+$ and
...
$\bar\eta_{\rm Hopf}\!\approx\!1.1$ (autonomous $f_0\!\approx\!54$~Hz); the carrier is

...
gamma resonance ($\Delta f=55$~Hz): spikes bunch into the envelope. \emph{(c)}~Entrained
($\bar\eta=1.5$, above the Hopf---an autonomous $\sim$54~Hz gamma cycle), TI off:
free-running gamma, no $\Delta f$ lock-in. \emph{(d)}~Entrained, TI on, with the beat set
\emph{below} the autonomous gamma (beat $\Delta f=42$~Hz, a detuning of $\approx$12~Hz
from $f_0\!\approx\!54$~Hz): the gamma bursts gate to the TI beat---the population rate
gains a $\Delta f$-locked component ($\sim$22$\times$), while the intrinsic gamma
persists. Placing the beat away from $f_0$ is what makes this genuine entrainment rather
than coincidence. \emph{Insets (b,d):} the population rate folded onto the $\Delta f$ beat
...
and $\Delta f=42$~Hz in the entrained regime ($\bar\eta=1.5$, above the Hopf)---a
...
f-f_0$ is a distinct quantity.) Placing the beat away from $f_0$ distinguishes true
entrainment from mere frequency coincidence. Timing is quantified by the quadrature
...
into the $\Delta f=42$~Hz envelope (a beat set $\approx$12~Hz below the intrinsic
gamma)---adding a $\Delta f$-locked component to the population rate---while the

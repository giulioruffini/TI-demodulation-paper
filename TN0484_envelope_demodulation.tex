...
\textbf{Author:} & Giulio Ruffini, Borja Mercadal, and Alex Just \\ 
\textbf{Affiliation:} & Neuroelectrics\,/\,Starlab\,/\,BCOM \\
\textbf{Date:} & 2026-06-17 \qquad \textbf{Version:} 0.7 \\
\textbf{DOI:} & \href{https://doi.org/10.5281/zenodo.20844275}{10.5281/zenodo.20844275} \\
\end{tabular}\\[4pt]
...
therefore changes only the damping $\gamma$, isolating the amplification cleanly. Code:
\texttt{nmm2\_jcA.py} (engine), \texttt{nmm2\_jcD.py}.
...
by the near-zero field-free baseline). Code: \texttt{qif\_raster.py},
...
acting (code: \texttt{timing\_not\_rate.py}).
...
Fig.~\ref{fig:qif_timing}a), and across both regimes the mean rate is essentially unchanged
...
of the in-vivo spike-timing-without-rate finding \cite{vieira2024} (code:
\texttt{qif\_raster.py}, \texttt{make\_qif\_figs.py}).

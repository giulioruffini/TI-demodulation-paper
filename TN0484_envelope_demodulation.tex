...
network's natural frequency. Where existing accounts locate the nonlinearity in cellular excitability, ours reads
...
output follows $\Delta f$ (diagonal); outside, it falls back to the autonomous $f_0$.
Here amplification is read as entrainment (tongue width, locking range), not as the
diverging $1/\gamma$ gain of the stable-focus side (Fig.~\ref{fig:jcurve}). Code:
\texttt{entrain.py}.}
\label{fig:entrain}
\end{figure}

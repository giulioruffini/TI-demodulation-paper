...
gamma. \emph{(d)} Entrained, TI on ($\Delta f=42$~Hz): the rhythm is re-timed to the TI
beat.}
...
(entrained) the free-running gamma is \emph{re-timed} to the TI beat---bands at the
autonomous $\sim$54~Hz realign to a detuned $\Delta f=42$~Hz envelope

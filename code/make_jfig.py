...
ax[1].set_xlabel(r'$\Delta f$ (Hz)'); ax[1].set_ylabel(r'$A_\Omega$ (mV)')
ax[1].set_title("(b)", loc="left", fontweight="bold"); ax[1].legend(fontsize=8); ax[1].grid(alpha=.3)
...
ax[2].set_xlabel(r'$1/\gamma$'); ax[2].set_ylabel(r'gain $A_\Omega/A_{\rm open}$')
ax[2].set_title("(c)", loc="left", fontweight="bold"); ax[2].legend(fontsize=8); ax[2].grid(alpha=.3,which='both')
plt.tight_layout()
import figstyle as _fs; _fs.scale_text(fig, placed_frac=1.0)
